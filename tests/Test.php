...
class Test extends TestCase
{
    ...
    public function testAuthorizationFlow() {
        ...
        $this->assertStringContainsString("http://localhost/oAuthServer/authorize?client_id=test_client&response_type=code&scopes=&redirect_uri=http%3A%2F%2Flocalhost%2Ftest&state=", $location[0]);
